...
class ClickHouseCluster:
    ...
    def __init__(
        ...
        self._lakekeeper_catalog_port = None
    ...
    @property
    def lakekeeper_catalog_port(self):
        if self._lakekeeper_catalog_port:
            return self._lakekeeper_catalog_port
        self._lakekeeper_catalog_port = self.port_pool.get_port()
        return self._lakekeeper_catalog_port
    ...
    def setup_iceberg_catalog_cmd(
        ...
        if file_name == "docker_compose_iceberg_lakekeeper_catalog.yml":
            env_variables["LAKEKEEPER_CATALOG_PORT"] = str(self.lakekeeper_catalog_port)
        self.base_cmd.extend(
            [
                "--file",
                p.join(
